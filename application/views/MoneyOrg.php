...
<div class="container-fluid col-md-12" ng-app="MyApp" ng-controller="Ctrl as ctr">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">جهات الصرف</h1>
          ...
          <div class="card shadow mb-4">
            <div class="c ard-header py-3">
              ...
              <h6 class="m-0 font-weight-bold text-primary">جهات الصرف</h6>
              </div>
              <div class="col-md-6" style="text-align:left;padding-left:1.25rem" >
              <button class="btn btn-primary" data-toggle="modal" data-target="#AddModal">إضافة جهة صرف</button>
              </div>
            ...
            <div class="card-body" style="padding-top:0">
              ...
              <div class="table-responsive" >
                <table  datatable="ng" dt-options="vm.dtOptions" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <tr ng-repeat="model in ctr.moneyOrgList"  ng-cloak>
...
<div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">إضافة جهة صرف</h5>
   ...
   <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">تعديل تعديل جهة صرف</h5>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">حذف صرف</h5>
      ...
      <script src="<?php echo base_url(); ?>assets/Scripts/MoneyOrg.js"></script>    