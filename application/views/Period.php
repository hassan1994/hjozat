...
<div class="container-fluid col-md-12" ng-app="MyApp" ng-controller="Ctrl as ctr">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">الفترات</h1>
          ...
          <div class="card shadow mb-4">
            <div class="c ard-header py-3">
              ...
              <h6 class="m-0 font-weight-bold text-primary">الفترات</h6>
              </div>
              <div class="col-md-6" style="text-align:left;padding-left:1.25rem" >
              <button class="btn btn-primary" data-toggle="modal" data-target="#AddModal">إضافة فترة</button>
              </div>
...
<div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">إضافة فترة جديدة</h5>
   ...
   <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">تعديل فترة</h5>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">حذف  فترة</h5>
      ...
      <script src="<?php echo base_url(); ?>assets/Scripts/Period.js"></script>    