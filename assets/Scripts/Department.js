 ...
 vm.ready =true;
    ...
    app.service('DataService', function ($http) {
        return {
            ...
            add: function (data) {
                return $http.post('/hjozat/Department/add',data);
           
            }, 
            edit: function (data) {
                return $http.post('/hjozat/Department/edit',data);
            }, 
            deleteModel  : function (model) {
                return $http.post('/hjozat/Department/delete',model);
            },         
