      ...
      vm.ready =false;
        function init() {
            ...
            vm.PeriodList = response.data;
             for (var i = vm.PeriodList.length - 1; i >= 0; i--) {
                 vm.PeriodList[i].value = parseInt(vm.PeriodList[i].value)
             }
    ...
    app.service('DataService', function ($http) {
        return {
            ...
            add: function (data) {
                return $http.post('/hjozat/Services/add',data);
           
            }, 
            edit: function (data) {
                return $http.post('/hjozat/Services/edit',data);
            }, 
            deleteModel  : function (model) {
                return $http.post('/hjozat/Services/delete',model);
            },         
